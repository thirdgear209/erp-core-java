...
import com.thirdgear.example.erp_api_demo.constants.ErrorConstants;
import com.thirdgear.example.erp_api_demo.service.ExceptionHandlerService;
...
public class GlobalExceptionHandler {
	...
	*/
    ...
    public ResponseEntity<ErrorMsg> handleGlobalException(Exception ex) {
        ...
        // return new ResponseEntity().internalServerError().header("", "").body("");
    }
